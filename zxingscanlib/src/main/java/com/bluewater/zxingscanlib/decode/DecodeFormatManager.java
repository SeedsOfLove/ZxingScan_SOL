...
import com.bluewater.zxingscanlib.android.Intents;
...
public final class DecodeFormatManager
{
    ...
    static
    {
        ...
        FORMATS_FOR_MODE.put(Intents.Scan.ONE_D_MODE, ONE_D_FORMATS);               //一维码
        FORMATS_FOR_MODE.put(Intents.Scan.PRODUCT_MODE, PRODUCT_FORMATS);
        FORMATS_FOR_MODE.put(Intents.Scan.QR_CODE_MODE, QR_CODE_FORMATS);           //QR Code
